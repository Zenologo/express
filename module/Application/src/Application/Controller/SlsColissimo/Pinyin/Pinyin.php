...
namespace  Application\Controller\SlsColissimo\Pinyin;
...
class Pinyin
{
    ...
    private function __construct()
    {
        if (is_null(static::$dictionary)) {
            self::set('accent', false);
            self::$dictionary = json_decode(file_get_contents(dirname(__DIR__).'/Pinyin/data/dict.php'), true);
        }
    }
